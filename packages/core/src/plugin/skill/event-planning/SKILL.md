...
2. Get the essentials — ask these together, not one at a time:
   - Who is it for?
...
4. Start with the highest-impact decision first — usually venue. Research options and present 2–3. For each, include:
   - Name and location
   - Capacity
...
6. For anything that requires booking or purchasing, always confirm before taking action. Show the cost and how it fits within the overall budget.

7. When the plan is taking shape, offer to draft:
   - **Invitations** — casual text message, email, or a more formal invite depending on the event. Show a draft for approval before sending.
   ...
   - **Vendor contact sheet** — names, phone numbers, confirmation numbers, what they're providing, and when they're providing it

8. For any booking that requires a phone call (restaurant reservation, venue hold, vendor inquiry), offer to draft talking points or confirm details.
