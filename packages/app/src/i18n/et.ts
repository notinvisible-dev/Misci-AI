export const dict = {
  ...
  "desktop.recovery.loadFailed": "Misci laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Misci aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Misci ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Misci installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.opencodeMissing": "Misci pole sellesse distrosse installitud",
  "desktop.wsl.error.opencodeCannotRun": "Misci on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.opencodeNotInstalled": "Misci pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Misci värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Misci",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Misci'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Misci.",
  ...
  "dialog.server.description": "Lülitage, millise Misci serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Misci kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Misci kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Misci värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Misci värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Misci jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Misci asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Misci saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Misci ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Misci.",
  ...
  "help.tabs.introduction": "Misci Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Misci ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Misci meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Misci ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Misci sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Misci Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Misci server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Misci kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Misci teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Misci järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Misci on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Misci käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Misci uusimat versiooni.",
