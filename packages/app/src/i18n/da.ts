export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Misci",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Misci.",
  ...
  "dialog.server.description": "Skift hvilken Misci-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Misci i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Misci i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Misci i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Misci kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Misci kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Misci igen.",
  ...
  "toast.update.description": "En ny version af Misci ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Misci-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Misci understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Misci inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Misci-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Misci",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Misci ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Misci skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Miscis tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Misci starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Misci.",
  ...
  "desktop.recovery.loadFailed": "Misci kunne ikke indlæses",
  "desktop.recovery.terminated": "Misci-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Misci mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.opencodeMissing": "Misci er ikke installeret i denne distribution",
  "desktop.wsl.error.opencodeCannotRun": "Misci er installeret, men kunne ikke køre",
  "desktop.wsl.error.opencodeNotInstalled": "Misci er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Misci er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Misci Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
