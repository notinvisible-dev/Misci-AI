...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Misci failed to load",
  "desktop.recovery.terminated": "Misci window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Misci is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Misci installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.opencodeMissing": "Misci is not installed in this distro",
  "desktop.wsl.error.opencodeCannotRun": "Misci is installed but could not run",
  "desktop.wsl.error.opencodeNotInstalled": "Misci is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Misci update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
