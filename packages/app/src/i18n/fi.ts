export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Miscin tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Miscissa.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Miscissa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Miscissa.",
  ...
  "dialog.server.description": "Vaihda Misci-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Miscia...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Miscia kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Miscia...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Miscia kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Misci jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Misci jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Miscia ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Misci voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Misci ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Misci uudelleen.",
  ...
  "toast.update.description": "Miscin uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Misci-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Misci ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Misci sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Misci-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Miscin näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Misci näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Misci järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Miscin teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Misci käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Miscin uusinta versiota.",
  ...
  "desktop.menu.documentation": "Misci-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Misci-valikko",
  ...
  "desktop.recovery.loadFailed": "Miscin lataaminen epäonnistui",
  "desktop.recovery.terminated": "Misci-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Misci ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Miscin asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.opencodeMissing": "Miscia ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.opencodeCannotRun": "Misci on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.opencodeNotInstalled": "Miscia ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Miscin päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Misci Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
