export const dict = {
  ...
  "desktop.menu.documentation": "Misci دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Misci لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Misci دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Misci جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Misci دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.opencodeMissing": "اس ڈسٹرو وچ Misci انسٹال نئیں اے",
  "desktop.wsl.error.opencodeCannotRun": "Misci انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ Misci انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Misci دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.model.unpaid.freeModels.title": "Misci دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Misci وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Misci وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Misci وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.server.description": "ایہہ ایپ کس Misci سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Misci چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Misci دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "Misci نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Misci نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Misci نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Misci اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "Misci {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "Misci تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Misci انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Misci انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Misci دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Misci ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Misci دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Misci Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Misci ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Misci ٹیم نوں دیو",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Misci ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Misci چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Misci سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Misci لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Misci کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Misci سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Misci نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Misci لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Misci دا تازہ ترین ورژن چلا رئے او۔",
