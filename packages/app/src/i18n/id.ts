export const dict = {
  ...
  "desktop.recovery.loadFailed": "Misci gagal dimuat",
  "desktop.recovery.terminated": "Jendela Misci berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Misci tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Misci gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.opencodeMissing": "Misci belum terinstal di distro ini",
  "desktop.wsl.error.opencodeCannotRun": "Misci telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "Misci belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Misci selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Misci",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Misci.",
  ...
  "dialog.server.description": "Ganti server Misci mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Misci di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Misci di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Misci di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Misci di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Misci dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Misci tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Misci ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Misci",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Misci belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Misci menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Misci di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Misci",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Misci di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Misci mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Misci diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Misci.",
