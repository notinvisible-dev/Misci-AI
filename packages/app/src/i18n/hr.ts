...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Misci se nije uspio učitati",
  "Prozor aplikacije Misci neočekivano je zatvoren",
  "Misci ne reagira",
  ...
  "Instalacija aplikacije Misci nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "Misci nije instaliran u ovoj distribuciji",
  "Misci je instaliran, ali se ne može pokrenuti",
  "Misci nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Misci je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Misci",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Misci.",
  ...
  "dialog.server.description": "Promijenite na koji se Misci poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Misci u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Misci u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Misci u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Misci u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Misci",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Misci može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Misci nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Misci.",
  ...
  "help.tabs.introduction": "Radna površina Misci sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Misci ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Misci timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Misci još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Misci uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Misci Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Misci poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Misci",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Misci izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Misci slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Misci tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Misci pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Misci.",
