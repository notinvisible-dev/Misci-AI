...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Misci yüklenemedi",
  "desktop.recovery.terminated": "Misci penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Misci yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Misci kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.opencodeMissing": "Misci bu dağıtımda kurulu değil",
  "desktop.wsl.error.opencodeCannotRun": "Misci kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.opencodeNotInstalled": "Misci, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Misci güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Misci tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Misci'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Misci'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Misci'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Misci sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Misci kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Misci kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Misci güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Misci güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Misci'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Misci'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Misci hazır.",
  "wsl.onboarding.opencodeReady": "Misci hazır.",
  "wsl.onboarding.installOpencodeIn": "Misci'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Misci'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Misci'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Misci bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Misci'u tekrar açın.",
  ...
  "help.tabs.introduction": "Misci Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Misci'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Misci ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Misci henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Misci ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Misci Masaüstü",
  ...
  "settings.desktop.wsl.description": "Misci sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Misci'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Misci'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Misci'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Misci'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Misci başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Misci'un en son sürümünü kullanıyorsunuz.",
