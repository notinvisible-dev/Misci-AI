...
export const dict = {
  ...
  "desktop.menu.documentation": "Misci-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Misci-meny",
  ...
  "desktop.recovery.loadFailed": "Misci kunne ikke lastes inn",
  "desktop.recovery.terminated": "Misci-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Misci svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Misci mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.opencodeMissing": "Misci er ikke installert i denne distribusjonen",
  "desktop.wsl.error.opencodeCannotRun": "Misci er installert, men kunne ikke kjøres",
  "desktop.wsl.error.opencodeNotInstalled": "Misci er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Misci er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Misci",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Misci.",
  ...
  "dialog.server.description": "Bytt hvilken Misci-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Misci ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Misci-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Misci ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Misci inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Misci-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Misci",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Misci ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Misci skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Misci.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Misci starter",
  ...
  "settings.updates.toast.latest.title": "Misci er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Misci.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Misci i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Misci i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Misci i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Misci i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Misci kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Misci kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Misci på nytt.",
  ...
  "help.tabs.introduction": "Misci Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
