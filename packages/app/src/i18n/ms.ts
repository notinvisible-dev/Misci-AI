export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Misci",
  ...
  "desktop.recovery.loadFailed": "Misci gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Misci ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Misci tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Misci gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.opencodeMissing": "Misci tidak dipasang dalam distro ini",
  "desktop.wsl.error.opencodeCannotRun": "Misci dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "Misci tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Misci selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Misci",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Misci.",
  ...
  "dialog.server.description": "Tukar pelayan Misci yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Misci dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Misci dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Misci dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Misci dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Misci boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Misci tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Misci ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Misci",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Misci belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Misci merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Misci dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Misci",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Misci pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Misci mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Misci.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Misci dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Misci.",
