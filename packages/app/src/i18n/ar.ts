export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Misci",
  "desktop.recovery.terminated": "توقفت نافذة Misci بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Misci لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Misci",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.opencodeMissing": "Misci غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.opencodeCannotRun": "Misci مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.opencodeNotInstalled": "Misci غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Misci، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Misci",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Misci Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Misci.",
  ...
  "dialog.server.description": "تبديل خادم Misci الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Misci...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Misci في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Misci...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Misci في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Misci في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Misci في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Misci من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Misci التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Misci.",
  ...
  "help.tabs.introduction": "أصبح Misci Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Misci ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Misci",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Misci لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Misci نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Misci داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Misci",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Misci على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Misci يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Misci.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Misci",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Misci.",
