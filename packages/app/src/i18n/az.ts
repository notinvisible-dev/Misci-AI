export const dict = {
  ...
  "desktop.recovery.loadFailed": "Misci yüklənə bilmədi",
  "desktop.recovery.terminated": "Misci pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Misci cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Misci quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.opencodeMissing": "Bu distribütivdə Misci quraşdırılmayıb",
  "desktop.wsl.error.opencodeCannotRun": "Misci quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.opencodeNotInstalled": "Misci {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Misci yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Misci tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Misci-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Misci-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Misci-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Misci serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Misci yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Misci yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Misci yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Misci yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Misci-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Misci-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Misci {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Misci hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Misci-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Misci quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Misci WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Misci bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Misci-u yenidən açın.",
  ...
  "help.tabs.introduction": "Misci Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Misci-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Misci komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Misci hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Misci-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Misci serverini işlət.",
  ...
  "settings.general.row.language.description": "Misci üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Misci-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Misci-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Misci-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Misci açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Misci-un ən son versiyasından istifadə edirsiniz.",
