export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Misci",
  ...
  "desktop.menu.ariaLabel": "Menú de Misci",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Misci",
  "desktop.recovery.terminated": "La ventana de Misci se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Misci no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Misci",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.opencodeMissing": "Misci no está instalado en esta distribución",
  "desktop.wsl.error.opencodeCannotRun": "Misci está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.opencodeNotInstalled": "Misci no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Misci finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Misci",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Misci.",
  ...
  "dialog.server.description": "Cambiar el servidor de Misci al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Misci en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Misci en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Misci en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Misci en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Misci pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Misci no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Misci ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Misci",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Misci aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Misci incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Misci dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Misci",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Misci en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Misci sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Misci.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Misci",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Misci.",
