export const dict = {
  ...
  "desktop.menu.documentation": "Misci-documentatie",
  ...
  "desktop.recovery.loadFailed": "Misci kan niet worden geladen",
  "desktop.recovery.terminated": "Het Misci-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Misci reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Misci is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.opencodeMissing": "Misci is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.opencodeCannotRun": "Misci is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.opencodeNotInstalled": "Misci is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Misci-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Misci",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Misci te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Misci te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Misci te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Misci-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Misci controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Misci controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Misci bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Misci bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Misci bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Misci bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Misci is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Misci in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Misci een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Misci kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Misci opnieuw.",
  ...
  "help.tabs.introduction": "Misci Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Misci ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Misci-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Misci ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Misci bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Misci-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Misci",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Misci eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Misci het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Misci aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Misci wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Misci is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Misci.",
