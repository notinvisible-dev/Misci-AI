export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Misci",
  ...
  "desktop.menu.ariaLabel": "Misci meni",
  ...
  "desktop.recovery.loadFailed": "Misci se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Misci-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Misci ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Misci-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.opencodeMissing": "Misci nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "Misci je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.opencodeNotInstalled": "Misci nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Misci-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Misci",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Misci-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Misci-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Misci-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Misci server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Misci u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Misci u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Misci u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Misci u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Misci mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Misci nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Misci-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Misci timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Misci još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Misci uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Misci server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Misci-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Misci izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Misci prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Misci-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Misci pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Misci-a.",
