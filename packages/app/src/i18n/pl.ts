export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Misci",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Misci",
  "desktop.recovery.terminated": "Okno Misci zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Misci nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Misci",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.opencodeMissing": "Program Misci nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.opencodeCannotRun": "Program Misci jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.opencodeNotInstalled": "Misci nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Misci została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Misci",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Misci.",
  ...
  "dialog.server.description": "Przełącz serwer Misci, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Misci w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Misci w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Misci w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Misci w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Misci będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Misci nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Misci ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Misci",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Misci nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Misci zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Misci wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Misci",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Misci na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Misci ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Misci.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Misci",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Misci.",
