export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Misci",
  ...
  "desktop.menu.ariaLabel": "Menu do Misci",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Misci",
  "desktop.recovery.terminated": "A janela do Misci foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Misci não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Misci",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.opencodeMissing": "O Misci não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O Misci está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O Misci não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Misci foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Misci",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Misci.",
  ...
  "dialog.server.description": "Trocar para qual servidor Misci este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Misci em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Misci em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Misci em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Misci",
  "wsl.onboarding.opencodeReadyIn": "O Misci está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Misci está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Misci em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Misci possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Misci não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Misci novamente.",
  ...
  "help.tabs.introduction": "Agora, o Misci Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Misci ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Misci",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Misci ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Misci inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Misci dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Misci",
  ...
  "settings.general.row.appearance.description": "Personalize como o Misci aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Misci segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Misci é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Misci iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Misci.",
