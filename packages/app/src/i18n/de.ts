...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Misci",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Misci zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Misci zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Misci zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Misci-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "Misci",
  ...
  "wsl.onboarding.checkingOpencode": "Misci wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Misci in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Misci wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Misci in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Misci in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Misci aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Misci ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Misci ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Misci in {{distro}}.",
  "wsl.onboarding.installOpencode": "Misci installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Misci einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Misci konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Misci erneut.",
  ...
  "toast.update.description": "Eine neue Version von Misci ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Misci-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Misci unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Misci mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Misci enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Misci Desktop",
  ...
  "settings.desktop.wsl.description": "Misci-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Misci ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Misci auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Misci dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Misci anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Misci automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Misci ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Misci wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Misci konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Misci-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Misci reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Misci-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.opencodeMissing": "Misci ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.opencodeCannotRun": "Misci ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.opencodeNotInstalled": "Misci ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Misci-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Misci Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
