export const dict = {
  ...
  "desktop.recovery.loadFailed": "Misci kunde inte läsas in",
  "desktop.recovery.terminated": "Misci-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Misci svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Misci misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.opencodeMissing": "Misci är inte installerat i den här distributionen",
  "desktop.wsl.error.opencodeCannotRun": "Misci är installerat men kunde inte köras",
  "desktop.wsl.error.opencodeNotInstalled": "Misci är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Misci-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Misci",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Misci.",
  ...
  "dialog.server.description": "Växla vilken Misci-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Misci i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Misci i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Misci i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Misci i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Misci kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Misci kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Misci igen.",
  ...
  "help.tabs.introduction": "Misci Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Misci ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Misci-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Misci stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Misci innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Misci-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Misci",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Misci ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Misci följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Miscis tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Misci startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Misci.",
