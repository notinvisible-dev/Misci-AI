...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Misci",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Misci.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Misci Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Misci.",
  ...
  "dialog.server.description": "Switch which Misci server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Misci in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Misci in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Misci in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Misci in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Misci can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Misci could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Misci ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Misci team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Misci does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Misci includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Misci server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Misci",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Misci looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Misci follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Misci is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Misci launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Misci.",
