export const dict = {
  ...
  "desktop.menu.documentation": "Misci Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Misci",
  ...
  "desktop.recovery.loadFailed": "Misci se nepodařilo načíst",
  "desktop.recovery.terminated": "Misci okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Misci nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Misci instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.opencodeMissing": "Misci není v této distribuci nainstalováno",
  "desktop.wsl.error.opencodeCannotRun": "Misci je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.opencodeNotInstalled": "Misci není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Misci aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Misci.",
  ...
  "dialog.server.description": "Přepněte, ke kterému Misci serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Misci v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Misci v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Misci v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Misci do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Misci může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Misci nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Misci.",
  ...
  "help.tabs.introduction": "Misci Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Misci ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Misci",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Misci zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Misci obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Misci uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Misci",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Misci na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Misci následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Misci.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Misci",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Misci.",
