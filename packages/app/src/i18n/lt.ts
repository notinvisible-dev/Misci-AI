...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Misci įkelti nepavyko",
  "Misci langas netikėtai užsidarė",
  "Misci neatsako",
  ...
  "Misci įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "Misci šiame distributyve neįdiegtas",
  "Misci įdiegtas, bet jo paleisti nepavyko",
  "Misci neįdiegtas distributyve {{distro}}",
  "Misci naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Misci modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Misci.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Misci serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Misci {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Misci {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Misci {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Misci į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Misci galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Misci nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Misci ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Misci komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Misci dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Misci apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Misci darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Misci serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Misci ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Misci atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Misci seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Misci temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Misci",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Misci versiją.",
