export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Misci",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Misci",
  "desktop.recovery.terminated": "La fenêtre Misci s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Misci ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Misci",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.opencodeMissing": "Misci n'est pas installé dans cette distribution",
  "desktop.wsl.error.opencodeCannotRun": "Misci est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.opencodeNotInstalled": "Misci n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Misci est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Misci",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Misci.",
  ...
  "dialog.server.description": "Changez le serveur Misci auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Misci dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Misci dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Misci dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Misci dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Misci puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Misci n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Misci ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Misci",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Misci ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Misci inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Misci dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Misci",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Misci sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Misci suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Misci.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Misci",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Misci.",
