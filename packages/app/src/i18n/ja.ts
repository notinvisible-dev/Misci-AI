export const dict = {
  ...
  "desktop.recovery.loadFailed": "Misciを読み込めませんでした",
  "desktop.recovery.terminated": "Misciのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Misciが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Misciのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.opencodeMissing": "このディストリビューションにはMisciがインストールされていません",
  "desktop.wsl.error.opencodeCannotRun": "Misciはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはMisciがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Misciのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Misciが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Misciで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してMisciで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Misciで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するMisciサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Misciを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のMisciを確認中...",
  "wsl.onboarding.updatingOpencode": "Misciを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のMisciを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のMisciを更新してください。",
  "wsl.onboarding.updateOpencode": "Misciを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のMisciの準備ができました。",
  "wsl.onboarding.opencodeReady": "Misciの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にMisciをインストールしてください。",
  "wsl.onboarding.installOpencode": "Misciをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misciがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MisciでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Misciをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Misci Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Misciの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをMisciチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: MisciはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Misciには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でMisciサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Misciの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのMisciの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Misciがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Misciのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Misci の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Misci は最新バージョンです。",
