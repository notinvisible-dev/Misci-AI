export const dict = {
  ...
  "desktop.menu.documentation": "Misci Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Misci ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Misci se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Misci se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Misci ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.opencodeMissing": "Misci ni nameščen v tej distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "Misci je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.opencodeNotInstalled": "Misci ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Misci je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Misci",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Misci.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Misci se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Misci ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Misci v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Misci ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Misci v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Misci v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Misci v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Misci doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Misci ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Misci ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Misci",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Misci še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Misci vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Misci znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Misci",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Misci izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Misci sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Misci.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Misci",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Misci.",
