export const dict = {
  ...
  "desktop.menu.documentation": "Misci دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Misci مینو",
  ...
  "desktop.recovery.loadFailed": "Misci لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Misci ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Misci جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Misci کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.opencodeMissing": "اس ڈسٹری بیوشن میں Misci انسٹال نہیں ہے",
  "desktop.wsl.error.opencodeCannotRun": "Misci انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Misci انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Misci کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "Misci کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Misci میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Misci میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Misci میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Misci سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Misci چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Misci چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Misci کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Misci کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Misci کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Misci کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Misci {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Misci تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Misci انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Misci انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Misci WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Misci اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Misci کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Misci Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Misci ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Misci ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Misci ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Misci میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Misci ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Misci سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Misci کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Misci کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Misci سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Misci کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Misci لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Misci کا تازہ ترین ورژن چلا رہے ہیں۔",
