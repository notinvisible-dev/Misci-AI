export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Misci",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Misci.",
  ...
  "provider.connect.opencodeZen.line1":
    "Misci Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Misci.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Misci.",
  ...
  "dialog.server.description": "Cambia il server Misci a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Misci...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Misci in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Misci...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Misci in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Misci in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Misci",
  "wsl.onboarding.opencodeReadyIn": "Misci è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Misci è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Misci in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Misci",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Misci non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Misci possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Misci non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Misci.",
  ...
  "help.tabs.introduction": "Misci Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Misci ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Misci",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Misci non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Misci include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Misci all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Misci",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Misci sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Misci segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Misci.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Misci",
  ...
  "settings.updates.toast.latest.title": "Misci è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Misci.",
  ...
  "desktop.menu.documentation": "Documentazione di Misci",
  ...
  "desktop.menu.ariaLabel": "Menu Misci",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Misci",
  "desktop.recovery.terminated": "La finestra di Misci si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Misci non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Misci non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.opencodeMissing": "Misci non è installato in questa distribuzione",
  "desktop.wsl.error.opencodeCannotRun": "Misci è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.opencodeNotInstalled": "Misci non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Misci è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
