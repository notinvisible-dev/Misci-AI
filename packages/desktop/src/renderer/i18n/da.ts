export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Misci er blevet downloadet. Vil du installere den og genstarte?",
