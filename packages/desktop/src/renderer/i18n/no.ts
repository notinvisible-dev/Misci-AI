export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Misci er lastet ned. Vil du installere den og starte på nytt?",
