export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Misci is gedownload. Wil je deze installeren en Misci opnieuw starten?",
