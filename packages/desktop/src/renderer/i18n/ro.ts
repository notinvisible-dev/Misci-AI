export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Misci a fost descărcată. Vrei să o instalezi și să repornești?",
