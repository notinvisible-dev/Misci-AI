export const dict = {
  ...
  "desktop.updater.none.message": "Már az Misci legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Misci {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
