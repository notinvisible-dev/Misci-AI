export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Misci versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Misci versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
