export const dict = {
  ...
  "desktop.updater.none.message": "Misci'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Misci'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
