export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Misci telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
