export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Misci.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Misci er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
