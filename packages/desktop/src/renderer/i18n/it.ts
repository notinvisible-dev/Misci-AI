export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Misci è stata scaricata. Vuoi installarla e riavviare l'app?",
