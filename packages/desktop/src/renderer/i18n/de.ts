export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Misci wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
