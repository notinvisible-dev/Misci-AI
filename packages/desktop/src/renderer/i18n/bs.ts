export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Misci-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Misci-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
