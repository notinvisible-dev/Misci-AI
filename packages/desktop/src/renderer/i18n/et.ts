export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Misci uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Misci'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
