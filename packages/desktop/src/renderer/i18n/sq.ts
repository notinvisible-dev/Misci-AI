export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Misci është shkarkuar, dëshironi ta instaloni dhe rinisni?",
