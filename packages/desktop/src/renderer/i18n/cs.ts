export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Misci. Chcete ji nainstalovat a aplikaci znovu spustit?",
