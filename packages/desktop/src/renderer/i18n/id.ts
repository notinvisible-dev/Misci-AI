export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Misci versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
