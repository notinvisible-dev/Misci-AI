export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Misci. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
