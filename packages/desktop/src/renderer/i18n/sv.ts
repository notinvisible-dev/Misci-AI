export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Misci har laddats ned. Vill du installera den och starta om programmet?",
