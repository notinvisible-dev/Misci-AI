export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Misci",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Misci. ¿Quieres instalarla y reiniciar?",
